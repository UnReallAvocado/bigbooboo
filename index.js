...
client.on ('interactionCreate', async (interaction) => {
          ...
          const { commandName, options} = interaction
                if (commandName === 'createwallet'){
                    ...
                    const embed1 = {
                        "type": "rich",
                        "title": `Ro-Sky Balance :money_with_wings:`,
                ...
                if (commandName === 'add'){
                    if (interaction.user.id ==='883320119051296869'){
                        ...
                        interaction.reply('You have no permission')
                    }
                ...
                if (commandName === 'setchannel'){
                    if (interaction.user.id === '883320119051296869'){
                        const e11 = {
                            "type": "rich",
                            "title": `Ro-Sky Withdraw :money_with_wings:`,
                            "description": 'Click button below to withdraw your robux',
                            "color": 0xEB3349,
                            "footer": {
                                "text": `Made by UnReallAvocado#6209`
                            }
                            ...
                            const row = new ActionRowBuilder()
                                                            .addComponents(
                                                                    ...
                                                                    .setLabel('Withdraw Robux')
                                                                    .setCustomId('with')
                                                                    
                                                            );
                            const channel = client.channels.cache.get('1024304731184693289');
                            channel.send({
                                embeds: [e11],
                                components: [row]
                            });
                            console.log('Interaction on')
                    }else{
                        interaction.reply('You have no permission')
                    }
